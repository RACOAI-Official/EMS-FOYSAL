...
import { updateTaskProgress, getUserTasks, downloadTaskPDF, backendUrl } from '../../../http';
  ...
  return (
    <>
        ...
        <div className="glass-card mb-4 p-4 d-flex justify-content-between align-items-center">
            <div>
                <h3 className="font-weight-bold text-dark mb-1">Welcome back, {user?.name}</h3>
                <p className="text-muted mb-0">Management Dashboard & Team Overview</p>
            </div>
            <div className="d-flex align-items-center gap-3">
                <div className="form-group mb-0" style={{ width: '250px' }}>
                    <select 
                        className="form-control rounded-pill border-0 shadow-sm search-mission-select" 
        ...
        <div className="glass-card mb-4 overflow-hidden">
          <div className="card-body p-0 d-flex flex-column flex-md-row">
            <div className="profile-img-container p-4 d-flex justify-content-center align-items-center bg-primary-soft">
              <img 
                className='img-fluid rounded-circle shadow-lg border-white border-4 profile-img' 
            ...
            <div className="p-4 flex-grow-1">
              <div className="row g-4">
                ...
                <div className="col-md-6 col-lg-4 mt-3">
                    <label className="text-uppercase text-muted small font-weight-bold d-block">Team Status</label>
        ...
        <div className="glass-card mb-5 border-0 shadow-lg">
            <div className="card-header bg-white border-bottom py-4 d-flex justify-content-between align-items-center">
                <h5 className="mb-0 font-weight-bold text-dark">
                    <i className="fas fa-tasks mr-2 text-primary"></i> Team Mission Tracking
                </h5>
                <span className="badge badge-primary rounded-pill px-3">{filteredTasks.length} Active Missions</span>
            </div>
            <div className="p-3">
                <table className="table table-borderless align-middle mb-0" style={{ borderCollapse: 'separate', borderSpacing: '0 12px' }}>
                    <thead>
                        <tr className="text-muted text-uppercase" style={{ fontSize: '0.75rem', letterSpacing: '1px' }}>
                            <th scope="col" className="ps-4">Mission Details</th>
                        ...
                        {filteredTasks.length === 0 ? (
                            <tr>
                                <td colSpan="4" className="text-center p-5">
                                    <div className="py-4">
                                        <i className="fas fa-clipboard-list fa-3x text-muted opacity-25 mb-3"></i>
                            ...
                            <tr key={task._id} className="soft-card shadow-sm hover-lift">
                                ...
                                <td>
                                    <div className="d-flex align-items-center">
                                        <div className="rounded-circle bg-primary text-white d-flex align-items-center justify-content-center mr-2 shadow-sm" style={{width: '32px', height: '32px', fontSize: '12px'}}>
                                    ...
                                    <div className="d-flex flex-column align-items-center gap-2">
                                        ...
                                        <div className="input-group input-group-sm" style={{ maxWidth: '100px' }}>
                                            ...
                                            <div className="input-group-append">
                                                ...
                                                >
                                                    {updatingId === task._id ? '..' : <i className="fas fa-check"></i>}
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                                  ...
                                  <div className="d-flex justify-content-end gap-2">
                                    ...
                                    {task.file && (
                                        <a 
                                            ...
                                            className="btn btn-sm btn-light border rounded-pill px-3 py-1 font-weight-bold shadow-sm"
                                        >
                                            <i className="fas fa-paperclip mr-1 text-primary"></i> Attachment
                                        </a>
                                    )}
                                  </div>
                                </td>
