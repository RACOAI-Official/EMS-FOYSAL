...
const SalaryView = () => {
    ...
    useEffect(()=>{
        const fetchData = async () => {
            ...
            const salaryData = res.data[0];
            const empRes = await getEmployee(salaryData.employeeID);
            const leaderRes = await getLeader(salaryData.employeeID)
            ...
            setFormData({
                ...
                reasonForBonus: salaryData.reasonForBonus || ''
            });
        }
        fetchData();
    ...
    const onSubmit = async (e) =>
    {
        ...
        const res = await updateSalary(submissionData);
        const {success} = res;
        if(success) {
          ...
          toast.error(res.message || "Failed to update salary");
        }
    }
