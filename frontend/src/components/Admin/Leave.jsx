...
const Leave = () => {
    ...
    const approveApplication = async() => {
      ...
      {
        toast.error("Cannot approve a rejected application");
        return;
      }
    ...
    const rejectApplication = async () => {
      ...
      if(application.adminResponse==="Approved")
      {
        toast.error("Cannot reject an approved application");
        return;
      }
      ...
      <section className="section">
              ...
              <div className="col-md-9">
                      ...
                      <button 
                        ...
                        className={`${application?.adminResponse==="Approved"?"btn-secondary":"btn-success"} btn btn-lg m-4 btn-icon-split`}
                      ...
                      <button 
                        ...
                        className={`${application?.adminResponse==="Rejected"?"btn-secondary":"btn-danger"} btn btn-lg m-4 btn-icon-split`}
                        disabled={application?.adminResponse === "Approved" || application?.adminResponse === "Rejected"}
                      >
                        Reject
                      </button>
