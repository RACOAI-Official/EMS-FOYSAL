...
const RowAddMember = ({index,data}) =>
{
  ...
  {
      // Don't remove from free employees - they can be in multiple teams now
      // Just add to team members if not already there
      const alreadyInTeam = (teamMembers || []).some(member => member.id === id);
      if (!alreadyInTeam) {
